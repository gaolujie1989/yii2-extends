...
*/
class Sales extends \lujie\amazon\sp\BaseAmazonSPClient
{
...
For example, ATVPDKIKX0DER indicates the US marketplace.
     ...
     *      - *granularityTimeZone* - string - optional
     ...
     *      - *fulfillmentNetwork* - string - optional
     ...
     */
    public function getOrderMetrics(array $query): array
    {
        return $this->api(array_merge(["/sales/v1/orderMetrics"], $query));
    }
