...
/**
 * Class ShipFulfillmentOrderJob
 * @package lujie\fulfillment\jobs
 * @author Lujie Zhou <gao_lujie@live.cn>
 */
class ShipFulfillmentOrderJob extends BaseFulfillmentOrderJob
{
    /**
     * @param Queue $queue
    ...
    public function execute($queue): void
    {
        ...
        $this->fulfillmentManager->shipFulfillmentOrder($this->getFulfillmentOrder());
    }
}
