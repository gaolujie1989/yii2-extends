...
class m201225_103020_fulfillment_order_add_type extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->dropIndex('idx_order_account', $this->tableName);
        $this->dropIndex('idx_external_order_account', $this->tableName);
        $this->dropIndex('idx_status_account', $this->tableName);

        $this->createIndex('idx_order_type_account', $this->tableName, ['order_id', 'fulfillment_type', 'fulfillment_account_id']);
    ...
    {
        $this->dropIndex('idx_order_type_account', $this->tableName);
        ...
        $this->createIndex('idx_order_account', $this->tableName, ['order_id', 'fulfillment_account_id']);
