...
class OttoMarketApi extends \lujie\otto\BaseOttoRestClient
{
     ...
     *          - Define the sort order of the resulting entries. Available values are 'desc' for 'newest lastModified first' and 'asc' for 'oldest lastModified first' - default is 'desc'
     * @return Iterator
     ...
     *      - *lastModified* - string
     *          - the ISO8601 timestamp of the last modification of the active status
     */
     ...
     * @param array $query
     *      - *fromDate* - string - optional
     *          - search for content changes from this ISO8601 date on. The maxmimum and default value is 28 days before now. Future values can be specified, but lead to an empty result.
     *      - *page* - integer - optional
     *          -
     *      - *limit* - integer - optional
     ...
     *      - *lastModified* - string
     *          - last change of the marketplace status as ISO8601 date
     */
     ...
     *          - a list of links that can be used for pagination.
     */
    public function eachV4Products(array $query = []): Iterator
    {
        return $this->eachInternal('getV4Products', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function batchV4Products(array $query = []): Iterator
    {
        return $this->batchInternal('getV4Products', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function getV4Products(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products"], $query));
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function createOrUpdateV4ProductVariations(array $data): array
    {
        return $this->api("/v4/products", 'POST', $data);
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function eachV4ProductActiveStatus(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductActiveStatus', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function batchV4ProductActiveStatus(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductActiveStatus', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function getV4ProductActiveStatus(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/active-status"], $query));
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function updateV4ProductActiveStatus(array $data): array
    {
        return $this->api("/v4/products/active-status", 'POST', $data);
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function eachV4ProductBrands(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductBrands', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function batchV4ProductBrands(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductBrands', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function getV4ProductBrands(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/brands"], $query));
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function eachV4ProductCategoryGroups(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductCategoryGroups', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function batchV4ProductCategoryGroups(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductCategoryGroups', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination (among others).
     */
    public function getV4ProductCategoryGroups(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/categories"], $query));
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function eachV4ProductContentChanges2(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductContentChanges2', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function batchV4ProductContentChanges2(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductContentChanges2', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function getV4ProductContentChanges2(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/content-changes"], $query));
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function eachV4ProductMarketPlaceStatusList(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductMarketPlaceStatusList', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function batchV4ProductMarketPlaceStatusList(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductMarketPlaceStatusList', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function getV4ProductMarketPlaceStatusList(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/marketplace-status"], $query));
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function eachV4ProductVariationPrices(array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductVariationPrices', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function batchV4ProductVariationPrices(array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductVariationPrices', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function getV4ProductVariationPrices(array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/prices"], $query));
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function updateV4ProductVariationPrices(array $data): array
    {
        return $this->api("/v4/products/prices", 'POST', $data);
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function getV4ProductProgressByProcessId(string $processUuid): array
    {
        return $this->api("/v4/products/update-tasks/{$processUuid}");
    }
     ...
     *      - *results* - array
     */
    public function getV4ProductFailedByProcessId(string $processUuid): array
    {
        return $this->api("/v4/products/update-tasks/{$processUuid}/failed");
    }
     ...
     *      - *results* - array
     */
    public function getV4ProductSucceededByProcessId(string $processUuid): array
    {
        return $this->api("/v4/products/update-tasks/{$processUuid}/succeeded");
    }
     ...
     *      - *results* - array
     */
    public function getV4ProductUnchangedByProcessId(string $processUuid): array
    {
        return $this->api("/v4/products/update-tasks/{$processUuid}/unchanged");
    }
     ...
     *      - *productSafety* -
     */
    public function getV4ProductVariation(string $sku): array
    {
        return $this->api("/v4/products/{$sku}");
    }
     ...
     *          - the ISO8601 timestamp of the last modification of the active status
     */
    public function getV4ProductVariationActiveStatus(string $sku): array
    {
        return $this->api("/v4/products/{$sku}/active-status");
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function eachV4ProductContentChanges(string $sku, array $query = []): Iterator
    {
        return $this->eachInternal('getV4ProductContentChanges', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function batchV4ProductContentChanges(string $sku, array $query = []): Iterator
    {
        return $this->batchInternal('getV4ProductContentChanges', func_get_args());
    }
     ...
     *          - a list of links that can be used for pagination.
     */
    public function getV4ProductContentChanges(string $sku, array $query = []): array
    {
        return $this->api(array_merge(["/v4/products/{$sku}/content-changes"], $query));
    }
     ...
     *          - last change of the marketplace status as ISO8601 date
     */
    public function getV4ProductMarketPlaceStatus(string $sku): array
    {
        return $this->api("/v4/products/{$sku}/marketplace-status");
    }
     ...
     *      - *sale* -
     */
    public function getV4ProductVariationPrice(string $sku): array
    {
        return $this->api("/v4/products/{$sku}/prices");
    }
     ...
     *      - *suspectedFraudCase* - boolean
     *          - Order is suspected fraud case or not
     */
     ...
     *      - *refundType* - string
     *          -    Field describes the business case of a refund in more detail.
     ...
     * **SERVICE_FULL_REFUND_CANCELLED_BY_SDU** - Refund of a service without item
     * **SERVICE_FULL_REFUND_PRODUCT_RETURNED** - Refund a service parallel to an item return
     ...
     * @tag ShippingProfiles-V1
     * @param array $data create shipping profile
     *      - *shippingProfileName* - string
     *          - ShippingProfileName allows the partner to assign a descriptive and unique name  for a shipping profile
     *      - *workingDays* - array
     *          - WorkingDays describe the specific days of the week on which the partner is available to process orders
     *      - *orderCutoff* - string
     *          - OrderCutoff specifies the time for orders to be placed, so the ProcessingTime starts within the same day. <br> This must be in half hour duration in (HH:MM) 24 hours format. The cut-off time must be specified in CET time.
     *      - *deliveryType* - string
     *          - DeliveryType describes how the product is being shipped. At the moment we support the enums shown above
     *      - *defaultProcessingTime* - integer
     *          - DefaultProcessingTime describes the time the partner needs to prepare the order for a shipment. Must be between 1 to 99. <br> If more than 72 days are transmitted in the DefaultProcessingTime, the product is marked as sold out on otto.de and cannot be ordered. <br> This is also the case if the DefaultProcessingTime and TransportTime add up to a value greater than 72. "1" day is considered as same-day shipping (0 days) until the cut-off time is reached.
     ...
     *          - successful message
     */
    public function createV1ShippingProfile(array $data): array
    {
        return $this->api("/v1/shipping-profiles", 'POST', $data);
    }

    /**
     * @description This GET API endpoint is to get all shipping profiles for a partner.
    Response is by default paginated with default page size of 200.
     ...
     * @return array
     *      - *results* - array
     *          - List of maximum 200 shipping profiles. Returns a cursor field if there are more than 200 shipping profile to get the next results.
     *      - *links* - object
     *          - link to next page if there are more than 200 shipping profiles
     */
    public function getV1ShippingProfiles(array $query = []): array
    {
        return $this->api(array_merge(["/v1/shipping-profiles"], $query));
    }
     ...
     * @tag ShippingProfiles-V1
     * @param string $shippingProfileId The id of the shipping profile in uuid4 format and the primaryKey for mapping a Profile to a SKU
     * @return array
     *      - *shippingProfileId* - string
     *          - Unique identifier for each shipping profile
     *      - *shippingProfileName* - string
     *          - ShippingProfileName allows the partner to assign a descriptive and unique name  for a shipping profile
     *      - *workingDays* - array
     *          - WorkingDays describe the specific days of the week on which the partner is available to process orders
     ...
     *          - TransportTime describes the time the carrier needs from collecting the order from partners warehouse until the first delivery attempt. Must be between 1 to 99. <br> If more than 72 days are transmitted in the TransportTime, the product is marked as sold out on otto.de and cannot be ordered. <br> This is also the case if the DefaultProcessingTime and TransportTime add up to a value greater than 72.
     */
    public function getV1ShippingProfileById(string $shippingProfileId): array
    {
        return $this->api("/v1/shipping-profiles/{$shippingProfileId}");
    }
     ...
     * @tag ShippingProfiles-V1
     * @param string $shippingProfileId The id of the shipping profile in uuid4 format and the primaryKey for mapping a Profile to a SKU
     * @param array $data shipping profile request
     *      - *shippingProfileName* - string
     *          - ShippingProfileName allows the partner to assign a descriptive and unique name  for a shipping profile
     *      - *workingDays* - array
     *          - WorkingDays describe the specific days of the week on which the partner is available to process orders
     ...
     *          - TransportTime describes the time the carrier needs from collecting the order from partners warehouse until the first delivery attempt. Must be between 1 to 99. <br> If more than 72 days are transmitted in the TransportTime, the product is marked as sold out on otto.de and cannot be ordered. <br> This is also the case if the DefaultProcessingTime and TransportTime add up to a value greater than 72.
     */
    public function updateV1ShippingProfile(string $shippingProfileId, array $data): void
    {
        $this->api("/v1/shipping-profiles/{$shippingProfileId}", 'PUT', $data);
    }
     ...
     * @param string $shippingProfileId The id of the shipping profile in uuid4 format and the primaryKey for mapping a Profile to a SKU
     */
    public function deleteV1ShippingProfile(string $shippingProfileId): void
    {
        $this->api("/v1/shipping-profiles/{$shippingProfileId}", 'DELETE');
    }
     ...
     * @return array
     */
    public function storeV1AvailabilityAvailableQuantities(array $data): array
    {
        return $this->api("/v1/availability/quantities", 'POST', $data);
    }
     ...
     *          - contains links to prev, self and next page url's
     */
    public function eachV1AvailabilityAvailableQuantities(array $query = []): Iterator
    {
        return $this->eachInternal('getV1AvailabilityAvailableQuantities', func_get_args());
    }
     ...
     *          - contains links to prev, self and next page url's
     */
    public function batchV1AvailabilityAvailableQuantities(array $query = []): Iterator
    {
        return $this->batchInternal('getV1AvailabilityAvailableQuantities', func_get_args());
    }
     ...
     *          - contains links to prev, self and next page url's
     */
    public function getV1AvailabilityAvailableQuantities(array $query = []): array
    {
        return $this->api(array_merge(["/v1/availability/quantities"], $query));
    }
     ...
     * @return array
     *      - *lastModified* - string
     *          - The last modified date and time of available quantity as a ISO8601 format (yyyy-MM-dd'T'HH:mm:ss.SSSX).
     *      - *quantity* - integer
     *          - The available quantity of a specific SKU, which can be any integer value >= 0.
     *      - *sku* - string
     *          - StockKeepingUnit given by partner configuration. e.g. 'shirt-red-M', external identifier of article variation.
     */
    public function getV1AvailabilityAvailableQuantityBySku(string $sku): array
    {
        return $this->api("/v1/availability/quantities/{$sku}");
    }

    /**
     * @description
     * @tag Availability-V1
     * @param array $data list of productDeliveryInformationRequestDTO
     *      - *shippingProfileId* - string
     *          - The ShippingProfileId is provided in the ShippingProfiles-API and is the PrimaryKey which is used to  map a specific Profile to a SKU
     *      - *processingTime* - string
     *          - The processingTime of a specific SKU, which can be any value between 1 and 99 or 'DEFAULT'. <br> When it is set to DEFAULT the defaultProcessingTime used in the shipping profile will be considered <br> Otherwise the defaultProcessingTime is overwritten and is not reset even if the shipping profile is changed. <br> It describes the time the partner needs to prepare the order for a shipment.
     *      - *sku* - string
     *          - StockKeepingUnit given by partner configuration. e.g. 'shirt-red-M', external identifier of article variation.
     * @return array
     */
    public function storeV1AvailabilityProductDeliveryInformation(array $data): array
    {
        return $this->api("/v1/availability/product-delivery-information", 'POST', $data);
    }

    /**
     * @description Retrieve sku and shipping profile mapping.The maximum number of returned skus is limited to 200.
     * @tag Availability-V1
     * @param array $query
     *      - *limit* - integer - optional
     *          - The maximum number of shipping profile and sku mappings to be returned in each response.
     *      - *cursor* - string - optional
     *          - Cursor for paging requests. If a cursor is provided, the only other request parameter being considered is 'limit'.

    Note:The cursor value must remain unchanged from the previous request.
     * @return Iterator
     *      - *results* - array
     *          - List of maximum 200 sku-shipping profiles. Returns a cursor field if there are more than 200 sku-shipping profiles mapping to get the next results.
     *      - *links* - object
     *          - link to next page if there are more than 200 mappings
     */
    public function eachV1AvailabilityProductDeliveryInformation(array $query = []): Iterator
    {
        return $this->eachInternal('getV1AvailabilityProductDeliveryInformation', func_get_args());
    }
     ...
     *          - link to next page if there are more than 200 mappings
     */
    public function batchV1AvailabilityProductDeliveryInformation(array $query = []): Iterator
    {
        return $this->batchInternal('getV1AvailabilityProductDeliveryInformation', func_get_args());
    }
     ...
     *          - link to next page if there are more than 200 mappings
     */
    public function getV1AvailabilityProductDeliveryInformation(array $query = []): array
    {
        return $this->api(array_merge(["/v1/availability/product-delivery-information"], $query));
    }
     ...
     * @tag Availability-V1
     * @param string $sku the sku in string format
     * @return array
     *      - *shippingProfileId* - string
     *          - The ShippingProfileId is provided in the ShippingProfiles-API and is the PrimaryKey which is used to  map a specific Profile to a SKU
     *      - *processingTime* - string
     ...
     *          - StockKeepingUnit given by partner configuration. e.g. 'shirt-red-M', external identifier of article variation.
     */
    public function getV1AvailabilityDeliveryInformationBySku(string $sku): array
    {
        return $this->api("/v1/availability/product-delivery-information/{$sku}");
    }
