 ...
 */
class <?= $generator->factoryClass ?> extends BaseOttoRestClientFactory
{
<?php foreach ($apiClassNames as $apiClassName): ?>

    /**
     * @param Account $account
     * @return <?= $apiClassName ?>|BaseOttoRestClient|null
     * @throws InvalidConfigException
     */
    public function get<?= $apiClassName ?>(Account $account): <?= $apiClassName ?>|BaseOttoRestClient|null
    {
