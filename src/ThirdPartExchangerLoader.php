 ...
 */
class ThirdPartExchangerLoader extends ObjectDataLoader
{
    ...
    protected function createObject(?array $data): ?object
    {
        ...
        $sourceConfig['restClient'] = $this->getClientConfig($data);
        $sourceConfig['resource'] = $data['resource'];
        $sourceConfig['class'] = $this->objectClass;
        $sourceConfig = array_merge($this->objectConfig, $sourceConfig);
        return Instance::ensure($sourceConfig);
    }
     ...
     * @inheritdoc
     */
    protected function getClientConfig(array $data): array
    {
