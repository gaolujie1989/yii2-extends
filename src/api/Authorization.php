...
*/
class Authorization extends \lujie\amazon\sp\BaseAmazonSPClient
{
...
For more information, see "Usage Plans and Rate Limits" in the Selling Partner API documentation.
     * @tag authorization
     * @param array $query
     *      - *sellingPartnerId* - string - required
     ...
     *      - *errors* - 
     */
    public function getAuthorizationCode(array $query): array
    {
        return $this->api(array_merge(["/authorization/v1/authorizationCode"], $query));
    }
