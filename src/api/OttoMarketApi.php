...
class OttoMarketApi extends \lujie\otto\BaseOttoRestClient
{
     ...
     */
    public function createOrUpdateV3ProductVariations(): array
    {
        return $this->api("/v3/products", 'POST');
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function updateV3ProductActiveStatus(): array
    {
        return $this->api("/v3/products/active-status", 'POST');
    }
     ...
     *          - a list of links that can be used to access detailed information about the process result
     */
    public function updateV3ProductVariationPrices(): array
    {
        return $this->api("/v3/products/prices", 'POST');
    }
     ...
     */
    public function storeV2AvailableQuantities(): void
    {
        $this->api("/v2/quantities", 'POST');
    }
     ...
     * @param string $trackingNumber The tracking number of the shipment assigned by the carrier.
     */
    public function appendV1ShipmentPositionItemsByCarrierAndTrackingNumber(string $carrier, string $trackingNumber): void
    {
        $this->api("/v1/shipments/carriers/{$carrier}/trackingnumbers/{$trackingNumber}/positionitems", 'POST');
    }
     ...
     * @param string $shipmentId Internal shipment identifier assigned by OTTO Market.
     */
    public function appendV1ShipmentPositionItems(string $shipmentId): void
    {
        $this->api("/v1/shipments/{$shipmentId}/positionitems", 'POST');
    }
     ...
     */
    public function createdAndSentV1MultiparcelShipment(): array
    {
        return $this->api("/v1/multiparcel-shipments", 'POST');
    }
     ...
     *          - Links related to the list. E.g. the link to the successive list used during paging.
     */
    public function eachV2ReturnPositionItemsFor(array $query = []): Iterator
    {
        return $this->eachInternal('getV2ReturnPositionItemsFor', func_get_args());
    }
     ...
     *          - Links related to the list. E.g. the link to the successive list used during paging.
     */
    public function batchV2ReturnPositionItemsFor(array $query = []): Iterator
    {
        return $this->batchInternal('getV2ReturnPositionItemsFor', func_get_args());
    }
     ...
     *          - Links related to the list. E.g. the link to the successive list used during paging.
     */
    public function getV2ReturnPositionItemsFor(array $query = []): array
    {
     ...
     */
    public function receiveV2AcceptedReturns(): void
    {
        $this->api("/v2/returns/acceptance", 'POST');
    }
     ...
     */
    public function receiveV2RejectedReturns(): void
    {
        $this->api("/v2/returns/rejection", 'POST');
    }
     ...
     *      - *results* -
     */
    public function applyV1PriceReduction(): array
    {
        return $this->api("/v1/price-reductions", 'POST');
    }
