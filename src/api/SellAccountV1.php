...
class SellAccountV1 extends \lujie\ebay\BaseEbayRestClient
{
    ...
    */
    ...
    {
        return $this->api("/fulfillment_policy/{$fulfillmentPolicyId}", 'DELETE');
    }
    ...
    * @return array
    */
    public function deletePaymentPolicy(string $paymentPolicyId): array
    {
        return $this->api("/payment_policy/{$paymentPolicyId}", 'DELETE');
    }
    ...
    * @return array
    */
    public function deleteReturnPolicy(string $returnPolicyId): array
    {
        return $this->api("/return_policy/{$returnPolicyId}", 'DELETE');
    }
    ...
    */
    ...
    {
        return $this->api("/sales_tax/{$countryCode}/{$jurisdictionId}", 'DELETE');
    }
