...
class SellComplianceV1 extends \lujie\ebay\BaseEbayRestClient
{
    ...
    * @return array
    */
    public function getListingViolationsSummary(array $query, array $headers): array
    {
        return $this->api(array_merge(["/listing_violation_summary"], $query), 'GET', [], $headers);
    }
    ...
    * @return array
    */
    public function getListingViolations(array $query, array $headers): array
    {
        return $this->api(array_merge(["/listing_violation"], $query), 'GET', [], $headers);
    }
    ...
    * @return array
    */
    public function suppressViolation(array $data, array $headers): array
    {
        return $this->api("/suppress_listing_violation", 'POST', $data, $headers);
    }
