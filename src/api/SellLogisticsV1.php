...
class SellLogisticsV1 extends \lujie\ebay\BaseEbayRestClient
{
    ...
    * @return array
    */
    public function createFromShippingQuote(array $data, array $headers): array
    {
        return $this->api("/shipment/create_from_shipping_quote", 'POST', $data, $headers);
    }
    ...
    * @return array
    */
    public function downloadLabelFile(string $shipmentId, array $headers): array
    {
        return $this->api("/shipment/{$shipmentId}/download_label_file", 'GET', [], $headers);
    }
    ...
    * @return array
    */
    public function createShippingQuote(array $data, array $headers): array
    {
        return $this->api("/shipping_quote", 'POST', $data, $headers);
    }
