...
/**
 * Class CancelSalesChannelOrderJob
 * @package lujie\sales\channel\jobs
 * @author Lujie Zhou <gao_lujie@live.cn>
 */
class CancelSalesChannelOrderJob extends BaseSalesChannelOrderJob
{
    /**
     * @param Queue $queue
     * @throws \Throwable
    ...
    public function execute($queue): void
    {
        ...
        $this->salesChannelManager->cancelSalesChannelOrder($this->getSalesChannelOrder());
    }
}