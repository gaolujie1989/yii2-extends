 ...
 */
class PullFulfillmentItemJob extends BaseObject implements JobInterface
{
    /**
    ...
    public function execute($queue)
    {
        ...
        $this->fulfillmentManager->pullFulfillmentItems($this->fulfillmentAccountId, $this->condition);
    }
}
