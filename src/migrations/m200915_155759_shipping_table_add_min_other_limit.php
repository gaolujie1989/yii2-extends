...
class m200915_155759_shipping_table_add_min_other_limit extends \yii\db\Migration
{
    ...
    {
        $this->addColumn($this->tableName, 'length_mm_min_limit', $this->integer()->notNull()->defaultValue(0)->after('height_mm_limit'));
        $this->addColumn($this->tableName, 'width_mm_min_limit', $this->integer()->notNull()->defaultValue(0)->after('length_mm_min_limit'));
        $this->addColumn($this->tableName, 'height_mm_min_limit', $this->integer()->notNull()->defaultValue(0)->after('width_mm_min_limit'));
