...
class FulfillmentDailyStockMovement extends \lujie\fulfillment\base\db\ActiveRecord
{
    ...
    {
        return [
            [['fulfillment_account_id', 'item_id', 'warehouse_id', 'movement_qty', 'movement_count'], 'default', 'value' => 0],
            [['external_item_key', 'external_warehouse_key', 'movement_type'], 'default', 'value' => ''],
            [['fulfillment_account_id', 'item_id', 'warehouse_id', 'movement_qty', 'movement_count'], 'integer'],
