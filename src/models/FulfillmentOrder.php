...
class FulfillmentOrder extends \lujie\fulfillment\base\db\ActiveRecord
{
    ...
    {
        return [
            [['fulfillment_account_id', 'fulfillment_status', 'order_id', 'order_updated_at', 'warehouse_id', 'external_created_at', 'external_updated_at', 'order_pushed_at', 'order_pushed_status', 'order_pulled_at', 'charge_pulled_at'], 'default', 'value' => 0],
            [['fulfillment_type'], 'default', 'value' => 'SHIPPING'],
            ...
            [['fulfillment_account_id', 'fulfillment_status', 'order_id', 'order_updated_at', 'warehouse_id', 'external_created_at', 'external_updated_at', 'order_pushed_at', 'order_pushed_status', 'order_pulled_at', 'charge_pulled_at'], 'integer'],
            [['external_order_additional', 'order_pushed_result', 'additional'], 'safe'],
            [['fulfillment_type'], 'string', 'max' => 10],
