...
return [
    ...
    [
        [
            ...
            "name2" => "Mario Soláns",
            "name3" => "",
            "address1" => "Rúa Río Barbantiño 10 2b",
            "address2" => "",
            "address3" => "10-2b",
        ],
    ...
    [
        [
            ...
            "name2" => "Pjeter",
            "name3" => "Gjoka",
            "address1" => "Pastorstraße 14/5/",
            "address2" => "",
            "address3" => "Tür 24",
        ],
        //如果address2为空，address1有数字，则提取address1的数字
        [
            "country" => "AT",
            "name1" => "",
            "name2" => "Pjeter",
            "name3" => "Gjoka",
            "address1" => "Pastorstraße ",
            "address2" => "14/5/",
            "address3" => "Tür 24",
        ]
    ],
    ...
    [
        [
            ...
            "name2" => "Stéphane",
            "name3" => "Baziak",
            "address1" => "Destreza Ventures SPRL",
            "address2" => "",
            "address3" => "Rue Victor Van Grootven N° 22 B",
        ],
        [
            "country" => "BE",
            "name1" => "Destreza Ventures SPRL",
            "name2" => "Stéphane",
            "name3" => "Baziak",
            "address1" => "Rue Victor Van Grootven  N° ",
            "address2" => "22 B",
            "address3" => "",
        ]
    ],
    [
        [
            "country" => "FR",
            "name1" => "",
            "name2" => "kherfallah elhadi",
            "name3" => "",
            "address1" => "21 R du Commandant Jean Duhail",
            "address2" => "",
            "address3" => "",
        ],
        [
            ...
            "name2" => "kherfallah elhadi",
            "name3" => "",
            "address1" => "R du Commandant Jean Duhail",
            "address2" => "21",
            "address3" => "",
        ]
    ],
